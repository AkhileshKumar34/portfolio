  ...
  return (
    <div id="about">
      ...
      <div className="about-data">
        ...
        <div>
          <h2 className="about-subtitle">I'am Akhilesh</h2>
          <p className="about-text">
            Bachelors degree in Electronics & Communication. I am always ready to have new experiences, meet new people and learn new things. I find the idea of creating value for people and impacting
